...
#      """construct dataset with image index """"
#     return TransformationSubset(dataset, get_indexes_from_set(
#         list(range(dataset[-1][-1].item()+1)), classes,
#         bucket_classes=bucket_classes, sort_classes=sort_classes, sort_indexes=sort_indexes),
...
class NCProtocol:
    def __init__(self, train_dataset: list, test_dataset: list,
                 fixed_class_order: Optional[Sequence[int]],
                 n_tasks: int,
                 train_transform=None, train_target_transform=None,
                 test_transform=None, test_target_transform=None,
                 steal_transforms_from_datasets=True, ):
...
class NCProtocolIterator:
    def __init__(self, protocol: NCProtocol,
        ...
        # for skip some task, no use currently
