...
"""
SEResNet implementation from Cadene's pretrained models_2
...
class SENet(AbstractCNN):
    ...
    def __init__(self, block, layers, groups, reduction, drop_rate=0.2,
        ...
        block (nn.Module): Bottleneck class.
            ...
            - For SE-ResNet models_2: SEResNetBottleneck
            - For SE-ResNeXt models_2:  SEResNeXtBottleneck
        layers (list of ints): Number of residual blocks for 4 layers of the
            network (layer1...layer4).
        groups (int): Number of groups for the 3x3 convolution in each
            bottleneck block.
            - For SENet154: 64
            - For SE-ResNet models_2: 1
            - For SE-ResNeXt models_2:  32
        reduction (int): Reduction ratio for Squeeze-and-Excitation modules.
            - For all models_2: 16
        dropout_p (float or None): Drop probability for the Dropout layer.
            If `None` the Dropout layer is not used.
            - For SENet154: 0.2
            - For SE-ResNet models_2: None
            - For SE-ResNeXt models_2: None
        inplanes (int):  Number of input channels for layer1.
            - For SENet154: 128
            - For SE-ResNet models_2: 64
            - For SE-ResNeXt models_2: 64
        input_3x3 (bool): If `True`, use three 3x3 convolutions instead of
            a single 7x7 convolution in layer0.
            - For SENet154: True
            - For SE-ResNet models_2: False
            - For SE-ResNeXt models_2: False
        downsample_kernel_size (int): Kernel size for downsampling convolutions
            in layer2, layer3 and layer4.
            - For SENet154: 3
            - For SE-ResNet models_2: 1
            - For SE-ResNeXt models_2: 1
        downsample_padding (int): Padding for downsampling convolutions in
            layer2, layer3 and layer4.
            - For SENet154: 1
            - For SE-ResNet models_2: 0
            - For SE-ResNeXt models_2: 0
        num_classes (int): Number of outputs in `last_linear` layer.
            - For all models_2: 1000
        """
