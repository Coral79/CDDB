...
class ConViT(nn.Module):
    ...
    def __init__(
            ...
            drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, qk_scale=None,
...
def _create_convit(variant, pretrained=False, default_cfg=None, **kwargs):
    if default_cfg is None:
        default_cfg = deepcopy(default_cfgs[variant])
    overlay_external_default_cfg(default_cfg, kwargs)

    model = build_model_with_cfg(ConViT, variant, pretrained, default_cfg=default_cfg, **kwargs)
