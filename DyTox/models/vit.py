...
default_cfgs = {
    # patch models_2 (my experiments)
    'vit_small_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/vit_small_p16_224-15ec54c9.pth',
    ),

    # patch models_2 (weights ported from official Google JAX impl)
    ...
    # patch models_2, imagenet21k (weights ported from official Google JAX impl)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        Args:
            ...
            distilled (bool): model includes a distillation token and head as in DeiT models_2
        ...
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other models_2
...
def checkpoint_filter_fn(state_dict, model):
    ...
    for k, v in state_dict.items():
        if 'patch_embed.proj.weight' in k and len(v.shape) < 4:
            # For old models_2 that I trained prior to conv based patchification
...
def _create_vision_transformer(variant, pretrained=False, default_cfg=None, **kwargs):
    ...
    if kwargs.get('features_only', None):
        raise RuntimeError('features_only not implemented for Vision Transformer models_2.')
...
def vit_small_patch16_224(pretrained=False, **kwargs):
    ...
    NOTE:
        ...
        * this model does not have a bias for QKV (unlike the official ViT and DeiT models_2)
    """
    model_kwargs = dict(
